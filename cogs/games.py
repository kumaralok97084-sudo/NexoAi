...
SLOT_EMOJIS = [f"{SLf"{SLf"{SLf"{SLf"{SLOT_DIAMOND}"GRAPE}"ORANGE}"LEMON}"CHERRY}", "🍋", "🍊", "🍇", "💎", "7️⃣"]
SLOT_PAYOUTS: dict[str, int] = {
    f"{SLOT_CHf"{SLOT_LEf"{SLOT_ORANGE}{SLOT_ORANGE}{SLOT_ORANGE}"SLOT_LEMON}{SLOT_LEMON}"{SLOT_CHERRY}{SLOT_CHERRY}": 3, "🍋🍋🍋": 5, "🍊🍊🍊": 7,
    f"{SLOT_GRAf"{SLOT_DIAMOND}{SLOT_DIAMOND}{SLOT_DIAMOND}"LOT_GRAPE}{SLOT_GRAPE}": 10, "💎💎💎": 20, "7️⃣7️⃣7️⃣": 50,
}
