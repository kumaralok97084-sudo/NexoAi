...
CATEGORIES = {
    ...
    "moderation": {
        ...
        "cmds": [
            ...
            ("/modconfig antispam", "Toggle anti-spam on/off"),
            ("/modconfig raidmode", "Toggle raid mode on/off"),
            ("/modconfig filter", "Toggle filter on/off"),
            ("/modconfig linkblock", "Toggle link blocking on/off"),
            ("/modconfig logging", "Toggle mod logging on/off"),
            ("/modconfig view", "View all mod config"),
            ("/messagelogs", "View message logs"),
            ("/tempban", "Temporarily ban a user"),
            ("/jail", "Jail a user (remove roles)"),
            ("/unjail", "Unjail a user"),
            ("/report", "Report a user to staff"),
            ("/appeal", "Appeal a moderation action"),
            ("/notebook", "Write a quick note"),
        ],
    },
    "admin": {
        "emoji": "\u2699\U0000fe0f",
